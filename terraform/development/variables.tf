...
variable "database_name" {
  ...
  default     = "sample_party_gmo_development"
}
...
variable "github_repository" {
  ...
  default     = "First_project_jiteraAPI"
}
...
variable "domain" {
  description = "Domain"
  default     = "sample-partygmo-development.project.jitera.app"
}
...
variable "bucket_name" {
  default = "sample-partygmo-development-storage"
}
